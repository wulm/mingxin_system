...
<div class="aui-banner-content aui-fixed-top" data-aui-slider  style="height: 320px;">
      ...
      <div class="m-actionsheet" id="actionSheet">
         <div style="position:relative">
            ...
            <div class="aui-product-function">
               <a href="car.html" class="yellow-color">加入拼团</a>
               <a href="order.html" class="red-color">发起拼团</a>
            </div>
...
<footer class="aui-footer-product">
   <div class="aui-footer-product-fixed">
      ...
      <div class="aui-footer-product-action-list">
         <a href="car.html" class="yellow-color" data-ydui-actionsheet="{target:'#actionSheet',closeElement:'#cancel'}">加入拼团</a>
         <a href="order.html" class="red-color" data-ydui-actionsheet="{target:'#actionSheet',closeElement:'#cancel'}">发起拼团</a>
      </div>
   </div>
</footer>
