...
<section id="actBody" class="aui-content content-positon">
   ...
   <div id="leftTime" style="width:100%;text-align: right;">
      <div class="aui-font-size-12" style="padding-right: 0.5rem;">开始倒计时:<font color="red">5天6时25分钟27秒</font></div>
   </div>
   <%--活动标题--%>
   <div id="actTitle" class="aui-product-title">
      <h2 class="aui-ellipsis-2">
         古田高岗露营，触摸自然，感受自然，倾听自然，更要喝到自然。
      </h2>
   ...
   <div id="groupCurrent">
      ...
      <div class="aui-flex-col aui-flex-center aui-border-t aui-border-b">
         <div class="aui-flex-item-2 aui-flex-row aui-flex-middle aui-padded-10">
            <img class="aui-img-round" src="<%=basePath%>resources/test/my/image/liulangnan.png">
         </div>
         <div class="aui-flex-item-3 aui-flex-row aui-flex-middle">
   ...
   <div class="Seg-line"></div>
   <%--跳转到店铺--%>
   <div id="goToShop" class="aui-margin-b-15">
      <ul class="aui-list aui-media-list">
         ...
         <li class="aui-list-item aui-list-item-middle">
            <div class="aui-media-list-item-inner">
               ...
               <div class="aui-list-item-right ">
                  <div class="aui-btn aui-btn-default" style="right: 0.6rem;"><span
                        class="aui-iconfont aui-icon-home"></span>进入逛逛
                  </div>
               </div>
            </div>
         </li>
