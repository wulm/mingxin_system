...
<%--弹出分享蒙版--%>
<div id="pop-Share" style="display: none;">
    ...
    <div class="modal-nowGroups-frame" id="modal-nowGroups-frame">
        ...
        <div class="aui-flex-col aui-border-b" style="height:15%;">
            ...
            <div id="nowGroups-close" style="position:absolute;top:0;right: 0;" class="aui-padded-5">
                <span id="closeBtn3" class="aui-iconfont aui-icon-close"></span>
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        function openModal(type) {/*pop-Share group-users-detail*/
            ...
            if (type == 1) {
                document.getElementById('pop-Share').style.display = 'block';
            }
            if (type == 2) {
        ...
        function closeModal(type) {
            ...
            if (type == 1) {
                document.getElementById('pop-Share').style.display = 'none';
            }
            if (type == 2) {
        ...
        $('#modal,#closeBtn3').click(function () {
            closeModal(1);
        });
        /*弹出和关闭邀请分享遮罩*/
