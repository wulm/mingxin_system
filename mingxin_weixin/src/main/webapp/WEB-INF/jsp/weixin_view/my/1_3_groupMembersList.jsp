...
<div style='display:none;'>
    <img src='<%=basePath%>resources/test/my/image/300x300.jpg'/>
</div>
<%--拼团用户列表主内容--%>
...
<%--弹出分享蒙版--%>
<div id="group-share-detail" class="modal" style="display: none;">
    <div style="color: white;text-align: center;">
        <%--顶部时间--%>
        <div class="aui-flex-col aui-padded-t-10 aui-padded-b-10  aui-flex-center ">
            <div class="aui-flex-col" style="background-color:#000000;border-radius: 0.3rem;">
                <span class=" aui-margin-l-15 aui-margin-r-15">22:34:06.6</span>
            </div>
        </div>
        <div class="aui-flex-col">
            <div id="share-image-icon" class="flex-row aui-flex-item-12 aui-padded-r-5">
                <img class=" aui-pull-right" src="<%=basePath%>resources/test/my/image/share-pic.png">
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        function rowBack() {
            if (css.top === '-0rem')
                css.top = '-1.5rem';
            else if (css.top === '-1.5rem')
                css.top= '-0rem';
            $('#share-image-icon').animate(css, 500, rowBack);
        }
        /*分享图片上下跳动动画*/
        function openModal(type) {/*打开遮罩窗口*/
...
//            document.getElementById('share-modal').style.display = 'block';
        ...
        /*关闭遮罩层*/
        function closeModal(type) {/*关闭遮罩窗口*/
            if (type != 1 && type != 2) {
                return;
            }
...
//            document.getElementById('share-modal').style.display = 'none';
        ...
        $('#group-share-detail,#btn-share-close').click(function () {
            closeModal(1);
        });
        /*弹出和关闭邀请分享遮罩*/
